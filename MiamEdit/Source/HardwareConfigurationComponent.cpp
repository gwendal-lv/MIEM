...
HardwareConfigurationComponent::HardwareConfigurationComponent ()
{
    ...
    addAndMakeVisible (label = new Label ("new label",
                                          CharPointer_UTF8 ("Configuration mat\xc3\xa9rielle...\n"
                                          "\xc3\x87""a va venir !")));
...
void HardwareConfigurationComponent::resized()
{
    ...
    label->setBounds (proportionOfWidth (0.5083f) - (157 / 2), proportionOfHeight (0.5100f) - (54 / 2), 157, 54);
...
<JUCER_COMPONENT documentType="Component" className="HardwareConfigurationComponent"
  ...
  <LABEL name="new label" id="9a9f35454556bd44" memberName="label" virtualName=""
         explicitFocusOrder="0" pos="50.83%c 51%c 157 54" bkgCol="87ffffff"
         edTextCol="ff000000" edBkgCol="0" labelText="Configuration mat&#233;rielle...&#10;&#199;a va venir !"
