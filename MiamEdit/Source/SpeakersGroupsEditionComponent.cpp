...
SpeakersGroupsEditionComponent::SpeakersGroupsEditionComponent ()
{
    addAndMakeVisible (label = new Label ("new label",
                                          CharPointer_UTF8 ("\xc3\x89""dition des groupes\n"
                                          "de haut-parleurs...\n"
                                          "\xc3\x87""a va venir !")));
...
//==============================================================================
void SpeakersGroupsEditionComponent::paint (Graphics& g)
{
...
void SpeakersGroupsEditionComponent::resized()
{
    //[UserPreResize] Add your own custom resize code here..
    //[/UserPreResize]

    label->setBounds (proportionOfWidth (0.5132f) - (157 / 2), proportionOfHeight (0.5017f) - (54 / 2), 157, 54);
...
<JUCER_COMPONENT documentType="Component" className="SpeakersGroupsEditionComponent"
  ...
  <LABEL name="new label" id="9a9f35454556bd44" memberName="label" virtualName=""
         explicitFocusOrder="0" pos="51.318%c 50.167%c 157 54" bkgCol="87ffffff"
         edTextCol="ff000000" edBkgCol="0" labelText="&#201;dition des groupes&#10;de haut-parleurs...&#10;&#199;a va venir !"
