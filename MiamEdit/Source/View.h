...
namespace Miam {
    ...
    /// \brief One of the three main modules of the MiamEdit program, that obeys orders from 
	...
	///
	/// \remark Usual GUI controls (created from the Projucer) belong to this modules.
    class View {
