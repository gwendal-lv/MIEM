...
void EditScene::resized()
{
    ...
    timeSlider->setBounds (((proportionOfWidth (0.0000f) + 0) + 0) + roundToInt (proportionOfWidth (1.0000f) * 0.0289f), ((((((proportionOfHeight (0.0756f) + proportionOfHeight (0.0756f)) + proportionOfHeight (0.0756f)) + proportionOfHeight (0.0756f)) + proportionOfHeight (0.0756f)) + proportionOfHeight (0.0756f)) + proportionOfHeight (0.0756f)) + proportionOfHeight (0.0756f) - -77, proportionOfWidth (0.9389f), proportionOfHeight (0.0756f));
    ...
    textButton->setBounds (proportionOfWidth (0.0354f), (((((((proportionOfHeight (0.0756f) + proportionOfHeight (0.0756f)) + proportionOfHeight (0.0756f)) + proportionOfHeight (0.0756f)) + proportionOfHeight (0.0756f)) + proportionOfHeight (0.0756f)) + proportionOfHeight (0.0756f)) + proportionOfHeight (0.0756f) - -77) + proportionOfHeight (0.0756f) - -32, proportionOfWidth (0.9486f), proportionOfHeight (0.0756f));
    ...
    addHexaShapeButton->setBounds ((proportionOfWidth (0.0000f) + 0) + 0, (((((proportionOfHeight (0.0756f) + proportionOfHeight (0.0756f)) + proportionOfHeight (0.0756f)) + proportionOfHeight (0.0756f)) + proportionOfHeight (0.0756f)) + proportionOfHeight (0.0756f)) + proportionOfHeight (0.0756f), proportionOfWidth (1.0000f), proportionOfHeight (0.0756f));
...
<JUCER_COMPONENT documentType="Component" className="EditScene" componentName=""
  ...
  <SLIDER name="new slider" id="31e65db12379ed8f" memberName="timeSlider"
          virtualName="" explicitFocusOrder="0" pos="2.894% -77R 93.891% 7.59%"
  ...
  <IMAGEBUTTON name="imgPlaybutton" id="2b4803c7ccf2d5d1" memberName="imgPlayButton"
               virtualName="" explicitFocusOrder="0" pos="0 7.59% 100% 7.59%"
  ...
  <IMAGEBUTTON name="imgStopButton" id="1ea8f58bfe76ab9b" memberName="imgStopButton"
               virtualName="" explicitFocusOrder="0" pos="0 0R 100% 7.59%" posRelativeX="210adb97ba16e19"
  ...
  <IMAGEBUTTON name="imgPauseButton" id="210adb97ba16e19" memberName="imgPauseButton"
               virtualName="" explicitFocusOrder="0" pos="0 0R 100% 7.59%" posRelativeX="2b4803c7ccf2d5d1"
  ...
  <IMAGEBUTTON name="imgOptionButton" id="bbfd3cbea2a71bfd" memberName="imgOptionButton"
               virtualName="" explicitFocusOrder="0" pos="0 -100% 100% 7.59%"
  ...
  <IMAGEBUTTON name="imgDeleteButton" id="9d5289b3af882e28" memberName="imgDeleteButton"
               virtualName="" explicitFocusOrder="0" pos="0 0R 100% 7.59%" posRelativeX="1ea8f58bfe76ab9b"
  ...
  <TEXTBUTTON name="new button" id="c84bea64b985b44" memberName="textButton"
              virtualName="" explicitFocusOrder="0" pos="3.537% -32R 94.855% 7.59%"
  ...
  <LABEL name="new label" id="289502be800b82cf" memberName="label" virtualName=""
         explicitFocusOrder="0" pos="2.572% 94.94% 94.855% 5.06%" edTextCol="ff000000"
  ...
  <GENERICCOMPONENT name="new component" id="1783a06d564fe381" memberName="addCarreShapeButton"
                    virtualName="ShapeButton" explicitFocusOrder="0" pos="0% 0R 100% 7.59%"
  ...
  <TEXTBUTTON name="saveButton" id="48fde7c3628a30fd" memberName="saveButton"
              virtualName="" explicitFocusOrder="0" pos="12.219% 2.048% 29.904% 5.06%"
  ...
  <TEXTBUTTON name="loadButton" id="3e438b12d4d1e208" memberName="loadButton"
              virtualName="" explicitFocusOrder="0" pos="60.129% 2.048% 29.904% 5.06%"
