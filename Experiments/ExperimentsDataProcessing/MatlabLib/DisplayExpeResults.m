...
ylabel('T');
title( "Characteristics T, E and I for experiment i = " + num2str(expeId));
...
subplot(3, 1, 3);
plot(synthsIds, expeResults(expeId).I(:,1), '+r');
hold on;
plot(synthsIds, expeResults(expeId).I(:,2), '*b');
ylabel('Performance Index I');
